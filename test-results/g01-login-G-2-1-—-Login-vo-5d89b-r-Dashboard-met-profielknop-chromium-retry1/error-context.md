...
- Name: g01-login.spec.ts >> G.2.1 — Login voor 3 rollen >> Login als VIEWER (viewer@nexus.local) → redirected naar Dashboard met profielknop
...
```
Error: loginAs viewer: Dashboard H1 niet zichtbaar. URL: http://localhost:3001/login — (emailveld waarde="")
```
...
- generic [active] [ref=f2e1]:
  - generic [ref=f2e3]:
    - generic [ref=f2e4]:
      - heading "Nexus" [level=1] [ref=f2e5]
      - paragraph [ref=f2e6]: Activation & Subscription Manager
    - generic [ref=f2e7]:
      - heading "Inloggen" [level=2] [ref=f2e8]
      - generic [ref=f2e9]:
        - generic [ref=f2e10]:
          - generic [ref=f2e11]: E-mailadres
          - textbox "E-mailadres" [ref=f2e12]:
            - /placeholder: naam@voorbeeld.nl
        - generic [ref=f2e13]:
          - generic [ref=f2e14]: Wachtwoord
          - textbox "Wachtwoord" [ref=f2e15]:
            - /placeholder: ••••••••
        - button "Inloggen" [ref=f2e16] [cursor=pointer]
    - paragraph [ref=f2e17]: Neem contact op met je beheerder voor accountgegevens.
    - paragraph [ref=f2e18]: "Seed credentials (na db seeden): admin@nexus.local / Test1234!"
  - alert [ref=f2e19]
```
