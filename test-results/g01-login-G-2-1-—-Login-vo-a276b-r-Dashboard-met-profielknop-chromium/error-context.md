...
- Name: g01-login.spec.ts >> G.2.1 — Login voor 3 rollen >> Login als ADMIN (admin@nexus.local) → redirected naar Dashboard met profielknop
...
```
Error: loginAs admin: Dashboard H1 niet zichtbaar. URL: http://localhost:3001/login — (emailveld waarde="")
```
