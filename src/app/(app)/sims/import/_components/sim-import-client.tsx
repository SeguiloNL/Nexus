...
export function SimImportClient() {
  ...
  useEffect(() => {
    if (commitState.committed) {
      ...
      setTimeout(() => router.push("/sims"), 1200);
    }
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload een CSV-bestand met kolommen: <code className="bg-slate-100 px-1 rounded">iccid</code>, <code className="bg-slate-100 px-1 rounded">provider</code> (optioneel: msisdn, imsi, simType, apn, providerActivationDate, providerDeactivationDate, notes).
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!preview ? (
            ...
            <div className="space-y-4">
              ...
              {committed ? (
                <div className="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 flex items-center gap-2">
                  ...
                  <strong>{committed.count}</strong> SIM-kaarten toegevoegd. Je wordt zo terug gestuurd...
                </div>
              ) : null}
