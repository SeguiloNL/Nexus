...
export function TrackerCsvImportDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload een CSV-bestand met kolommen: serialNumber, imei, brand,
            model (optioneel: hardwareType, firmwareVersion, purchaseDate,
            supplier, notes).
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 flex-1 overflow-y-auto">
            ...
            {committed ? (
              <div className="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 flex items-center gap-2">
                ...
                <strong>{committed.count}</strong> trackers toegevoegd.
              </div>
            ) : null}
              ...
              <DialogFooter className="gap-2 sm:justify-between">
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    onClick={() => {
                      // Reset state: start opnieuw met upload
                      location.reload();
                    }}
